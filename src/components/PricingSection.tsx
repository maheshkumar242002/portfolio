...
function PricingCard({ plan, index }: { plan: PricingPlan; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className={`p-8 flex flex-col flex-grow ${plan.popular ? 'pt-14' : ''}`}>
        ...
        <div className="text-center mb-8">
          {plan.price === 'custom' ? (
            ...
            <div className="flex items-baseline justify-center gap-1">
              ...
              <span className="text-5xl font-black text-gradient">{plan.price.toLocaleString()}</span>
            </div>
          )}
          <p className="text-sm text-[var(--color-text-muted)] mt-1">
            {plan.price === 'custom' ? 'Tailored to your needs' : 'Starting price'}
          </p>
        </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="section-description mx-auto mt-4">
            Choose the perfect package for your project. All plans include our commitment to quality.
          </p>
        </div>
        ...
        <div className={`mt-16 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center">
            <p className="text-[var(--color-text-secondary)] mb-6">
              Need something different? We offer custom solutions for unique requirements.
            </p>
        ...
        {/* FAQ Teaser */}
        <div className={`mt-16 max-w-2xl mx-auto transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-8 text-center">
            <h3 className="text-xl font-bold text-[var(--color-text-primary)] mb-2">
              Have questions about pricing?
            </h3>
            <p className="text-[var(--color-text-secondary)] mb-6">
              We're happy to discuss your project requirements and provide a detailed quote.
            </p>
            <button

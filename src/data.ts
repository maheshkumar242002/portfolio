...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "A full-featured e-commerce solution with real-time inventory, multi-vendor support, and advanced analytics dashboard.",
  ...
  },
  {
    ...
    description:
      "Cross-platform health tracking app with wearable integration, personalized insights, and telehealth features.",
  ...
  },
  {
    ...
    description:
      "Enterprise project management tool with Gantt charts, resource allocation, and team collaboration features.",
  ...
  },
  {
    ...
    description:
      "Desktop application for financial portfolio management with real-time market data and AI-powered insights.",
  ...
  },
  {
    ...
    title: "EduLearn LMS",
    description:
      "Learning management system with video streaming, interactive quizzes, and progress tracking.",
  ...
  },
  {
    ...
    description:
      "On-demand delivery app with real-time tracking, route optimization, and driver management.",
